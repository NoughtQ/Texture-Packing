...
def draw_rectangles(rectangles,canvas_width,output_file):
    ...
    ax.text(canvas_width + 1, max(y_coords), f'{max(y_coords):.2f}', color='r', va='center')
    ax.text(canvas_width + 1, -1, f'{canvas_width}', color='b', va='center')
...
for i in range(0, 2):
    # 文件路径
    file_path = f'code/outputs/BL/recs/rectangles{i}.txt'
    #file_path = f'code/outputs/FFDH/rects/rectangle{i}.txt'
    output_file = f'code/outputs/BL/figs/fig{i}.png'
    #output_file = f'code/outputs/FFDH/figs/fig{i}.png'
